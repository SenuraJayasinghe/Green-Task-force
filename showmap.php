    ...
    function initMap() {
        ...
        for (i = 0; i < locations.length; i++) {
            ...
            marker = new google.maps.Marker({
                ...
                map: map,
                icon :   locations[i][4] == '1' ?  purple_icon:r ,
                html: document.getElementById('form')
            });

            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                    confirmed =  locations[i][4] === '1' ;
...
<div style="display: none" id="form">
    <table class="map1">
        ...
        <tr>
            <input name="id" type='hidden' id='id'/>
            <td><a>Address:</a></td>
            <td><textarea disabled id='address' placeholder='Address'></textarea></td>
        </tr>
        <tr>
            <input name="id" type='hidden' id='id'/>
            <td><a>Collecting Time:</a></td>
            <td><textarea disabled id='time' placeholder='Collecting Time'></textarea></td>
