        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="https://images.pexels.com/photos/2977513/pexels-photo-2977513.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <?php include('errors.php'); ?>
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-outline-success btn-lg btn-block" type="submit" name="login_user1"
                    >Login</button>
                  </div>
